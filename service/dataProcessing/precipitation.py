"""Precipitation data filtering utilities."""
...
DATASET_FILENAME = "precip.mon.total.2.5x2.5.v2020.nc"
...
class PrecipitationQuery(BaseModel):
	"""User-provided filters for extracting precipitation data."""
	...
	@model_validator(mode="after")
	def validate_dates(self) -> "PrecipitationQuery":
...
def _load_dataset() -> xr.Dataset:
	"""Load and cache the precipitation dataset."""
...
def filter_precipitation_data(
	start_date: datetime = DEFAULT_START,
	end_date: datetime = DEFAULT_END,
	region: RegionBounds | None = None,
) -> Dict[str, object]:
	"""Slice the precipitation dataset by date and region and return summary stats."""
